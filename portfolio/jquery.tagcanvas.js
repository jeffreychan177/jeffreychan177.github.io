...
(function (ap) {
  ...
  function Y(aJ, aI) {
    ...
    return (
      (j &&
        j.getComputedStyle &&
        j.getComputedStyle(aJ, null).getPropertyValue(aI)) ||
  ...
  x.DrawColour = function (aJ, aM, aK, aN, aI, i, aO, j, aL) {
    ...
    return this[aO.image ? "DrawColourImage" : "DrawColourText"](
      aJ,
      aM,
      aK,
      aN,
  ...
  x.DrawPulsate = function (aM, i, j, aJ) {
    var aK = G() - this.ts,
      ...
      aL =
        aI.pulsateTo +
        (1 - aI.pulsateTo) *
          (0.5 + w((2 * Math.PI * aK) / (1000 * aI.pulsateTime)) / 2);
      ...
      if (aQ.outlineMethod == "colour") {
        ...
        if (aQ.outlineMethod == "size") {
          aO = t(
            this.text,
            this.textFont,
            this.textHeight + aQ.outlineIncrease
          );
          i = aO.max.y + aO.min.y;
          aK =
            aR * (this.textHeight + aQ.outlineIncrease) + "px " + this.textFont;
          aN.font = aK;
          aI = this.MeasureText(aN);
          aL = new g(
            this.text,
            ...
            if ("size" == j) {
              if (aJ.weightSizeMin > 0 && aJ.weightSizeMax > aJ.weightSizeMin) {
                this.textHeight =
                  aJ.weightSize *
                  (aJ.weightSizeMin +
                    (aJ.weightSizeMax - aJ.weightSizeMin) * i);
              } else {
    ...
    if (aN && this.fixedAnim.active) {
      ...
      for (aW = 0; aW < aV; ++aW) {
        aZ =
          this.mx >= 0 &&
          this.my >= 0 &&
          this.taglist[aW].CheckActive(aY, aQ, aP);
